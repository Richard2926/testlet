...
class CropPage2 extends StatefulWidget {
  CropPage2({Key key, this.title, this.image, this.imageInfo, this.docNo, this.frontCards, this.test})
      : super(key: key);
  final String title;
  final File image;
  final int docNo;
...
class _CropPageState extends State<CropPage2>
...
//
    ...
    for (int i = 0; i <= div; i++) {
      ...
      //firebaseStorageRef.putFile(temp);
...
//    print(tests);
    Navigator.pushNamed(
      context,
      create.routeName,
      arguments: createArguments(widget.frontCards, tests, widget.test, null),
    );
  }
...
//      context,
//      create.routeName,
//      arguments: createArguments(widget.frontCards, ["ans1", "ans2"], 1),
//    );
    _controller.repeat();
    _capturePng();
    setState(() {
      ...
      return new WillPopScope(
        ...
        child: new Scaffold(
          appBar: GradientAppBar(
            title: new Text('Pick Back Cards',
                style: TextStyle(
                    fontSize: 24.0,
