...
class _MyHomePageState extends State<messaging> {
  ...
  Future<List> _display() async {
    ...
    if (maindata == null) {
      maindata = await auth.getInvites();
    }
    return maindata;
  }
                                    ...
                                    return Dismissible(
                                      ...
                                      confirmDismiss:
                                        ...
                                        if (direction == delete) {
                                                ...
                                                title: const Text("Confirm",
                                                    style: TextStyle(
                                                        ...
                                                        color: FintnessAppTheme
                                                            .black)),
                                                content: const Text(
                                                    "Do you want to add this to your sets?",
                                                    style: TextStyle(
                                                        fontSize: 15.0,
                                                        fontWeight:
                                                            FontWeight.w500,
                                          ...
                                          startup(tnum, text, cre, desc, couns,
                                              false);
                                          res = false;
                                        }
  ...
  List buildThis(List list, Color color) {
    list.add(
      Padding(
        padding:
            EdgeInsets.only(top: MediaQuery.of(context).size.height / 3.5 - 46),
        child: Ink(
  ...
  Future<void> _delete(int docNo, String name, String creator,
    ...
    await auth.removeInvite(docNo, creator);
...
//                    tileMode: TileMode.clamp),
  ...
  Future<void> startup(int docNo, String name, String creator,
      String description, int count, bool b) async {
    setState(() {
      isloading = true;
    });
    var x;
    ...
    if (b == true) {
      Navigator.pushNamed(
        ...
        arguments: ScreenArguments(
            x, docNo, false, false, true, name, description, creator),
      );
    } else {
      Navigator.pushNamed(
        context,
